...
cmd /c mvn clean source:jar javadoc:jar install -P jdk9,jdk13,jdk14,jdk15,jdk16,%profilelist%,%profilelist2%,%profilelist3%  %1 %2 %3 %4 -DskipTests=true -Djdk.release=17
cd ..
cd ..
cd ..
