...
public interface MessageMethod extends Comparable<MessageMethod>, JavaDocComment, DelegatingExecutableElement {
    ...
    /**
     * The {@link org.jboss.logging.processor.model.MessageMethod.Message} to be used for the method.
     *
     * @return the message.
     */
    Message message();
     ...
     * {@link org.jboss.logging.processor.model.MessageMethod.Message} was inherited from a different method, otherwise {@code false}.
     * <p/>
