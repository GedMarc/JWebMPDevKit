...
public class ClassModelFactory {
     ...
     *
     * @throws IllegalArgumentException if interface is not annotated with {@link org.jboss.logging.annotations.MessageBundle @MessageBundle} or {@link org.jboss.logging.annotations.MessageLogger @MessageLogger}
     */
